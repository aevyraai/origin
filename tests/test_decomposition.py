...
class TestRunDecompositionLinear:
    def test_happy_path_single_failed_criterion(self):
        ...
        result = run_decomposition(
            trace=trace, score=0.3, rubric="Quality rubric.", llm=_stub_llm(resp)
        )
                    ...
                    [
                        {
                            ...
                            "node_name": "plan",
                            "contribution": 0.6,
                            "reasoning": "Step 1 bad.",
                        },
                        {
                            "node_id": "p2",
                            "node_name": "plan",
                            "contribution": 0.4,
                            "reasoning": "Step 2 bad.",
                        },
                    ],
                ),
            ]
...
class TestRunDecompositionErrors:
    ...
    def test_non_boolean_satisfied_raises(self):
        ...
        trace = linear_trace()
        resp = json.dumps(
            {"criteria": [{"criterion": "Accurate", "satisfied": "maybe", "nodes": []}]}
        )
